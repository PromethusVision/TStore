# Product-Specific Merchant Quality Options

**State:** OPTIONS — DEFERRED

## Options

- No product/category reputation: use shop rating plus factual listing information.
- Category-specific factual signals: availability/listing accuracy by stable category ID with minimum sample.
- Product-specific score: highest granularity, privacy/sparsity/gaming risk; not recommended.
