# Reputation: Shop vs Merchant Model
...
|---|---|---|
| A — Shop-first | Evidence matches actual branch/customer experience | Multi-branch merchant view needs aggregation. |
| B — Merchant-org-first | Simpler brand story | Masks branch differences; identity model not yet canonical. |
| C — Layered | Shop facts plus explainable org roll-up | Highest data/UX complexity. |
