...
| BND-018 | Home textile vs kitchen textile | Ev & Yaşam | Züccaciye & Mutfak | Task intent and physical product type decide | Kitchen-task textile → Züccaciye; bedding/bath/general → Ev | NO | Conditional | PASS |
| BND-019 | Manual kitchenware vs appliance | Züccaciye & Mutfak | Beyaz Eşya & Ev Aletleri | Powered preparation device is appliance; manual product is houseware | Existing split | NO | YES | PASS |
| BND-020 | Decorative, smart and fixed lighting | Ev & Yaşam | Elektronik/Hırdavat | Non-smart finished luminaire, smart endpoint and fixed installation are separate | Ev / Elektronik / Hırdavat respectively | NO | YES | PASS |
| BND-021 | Garden furniture and powered/manual garden tools | Çiçek & Bahçe | Ev & Yaşam/Hırdavat | Furniture → Ev; powered/industrial tool → Hırdavat; manual garden-first tool → Bahçe | Existing functional owners | NO | YES | PASS |
| BND-022 | Cleaning chemical vs cleaning appliance | Ev & Yaşam | Beyaz Eşya & Ev Aletleri | Consumable/manual tool differs from powered appliance | Ev for chemical/manual; appliances for powered device | NO | YES | PASS |
| BND-023 | Cosmetic vs medical intended use | Kozmetik & Kişisel Bakım | Sağlık & Medikal | Therapeutic/diagnostic intended use overrides cosmetic form | Sağlık only after professional gate; ordinary cosmetic stays Kozmetik | NO | YES | PASS |
| BND-024 | Baby-specific personal care | Kozmetik & Kişisel Bakım | Anne & Bebek | Baby-specific intended age is schema-bearing in baby-care context | Anne & Bebek; general-use product remains Kozmetik | NO | YES | PASS |
...
| BND-033 | Pet food vs human food | Evcil Hayvan Ürünleri | Gıda & İçecek | Intended species is a legitimate product-domain discriminator here | Evcil Hayvan Ürünleri | NO | YES | PASS |
| BND-034 | Veterinary/therapeutic pet product | Evcil Hayvan Ürünleri | Sağlık & Medikal | No veterinary medicine normal leaf; treatment claims fail closed | No ordinary assignment pending separate policy | NO | YES | PASS — FAIL_CLOSED |
...
| BND-044 | Printer-specific consumable vs office paper | Bilgisayar anchor | Kırtasiye & Ofis | Toner/cartridge/drum is Computer; generic paper/label/thermal roll is Stationery | Preserve anchor rules | NO | Conditional | PASS |
| BND-045 | SBC vs microcontroller board | Bilgisayar anchor | Elektronik anchor | General-purpose OS computer differs from embedded controller | SBC → Computer Components; Arduino/ESP → Electronics Components | NO | Conditional | PASS |
| BND-046 | Vehicle first-aid kit vs general first-aid kit | Otomotiv & Motosiklet | Sağlık & Medikal | Mandatory vehicle-set identity differs from general medical kit | Automotive set / Health general kit | NO | YES | PASS |
| BND-047 | Motorcycle protective products | Otomotiv & Motosiklet | Giyim/Ayakkabı/Spor/Hırdavat | Vehicle protection is intrinsic to motorcycle use | Otomotiv & Motosiklet | NO | YES | PASS |
| BND-048 | Plant grow light vs generic/smart light | Çiçek & Bahçe | Ev/Elektronik/Hırdavat | Plant-first specialized system differs from household light or fixed wiring | Bahçe only for plant-first product | NO | YES | PASS |

## 3. Exact-name collision check

One terminal display name repeats across L1s:

- `Fren Parçaları`: `Spor & Outdoor → Bisiklet → Bisiklet Parçaları` and `Otomotiv & Motosiklet → Motosiklet Yedek Parçaları`.

This is not a duplicate canonical path or shared product identity. Bicycle and motorcycle fitment, standards, attributes and merchant evidence differ; the parent path is mandatory identity context. Recommendation: **retain both scoped leaves; do not globalize the display name into one shared node**.

Global full-path duplicates: **0**.

## 4. PPE and safety-footwear resolution

| Product | Recommended owner | Evidence rule |
|---|---|---|
| Ordinary occupational/service shoe | Ayakkabı → İş & Profesyonel Ayakkabılar | No certified protection-first claim |
| Certified safety shoe/boot | Yapı, Hırdavat & Tesisat → İş Güvenliği Ayakkabıları | Applicable PPE certification and intended use |
| Ordinary rain/snow/trekking boot | Ayakkabı | Weather/activity is ordinary footwear use |
| Sport-specific hard protector | Spor & Outdoor | Activity-specific protection, not occupational PPE |
| Motorcycle boot/glove/jacket/helmet | Otomotiv & Motosiklet | Motorcycle-first protective design |
| Occupational protective eyewear/apparel | Yapı, Hırdavat & Tesisat PPE | Workplace protection-first evidence |
| Optical/sun eyewear | Gözlük & Optik | Corrective/optical/sun primary function |
...
Automated terminal-name screening produced lexical false positives such as `servis kaşığı`, `servis ayakkabısı`, `tamir parçası`, `muayene eldiveni` and `terapi egzersiz ürünü`; each denotes a physical product. Manual semantic review found:

- labor: 0 active leaves;
- booking/reservation: 0;
- installation/repair service: 0;
- subscription/digital service: 0;
- medical service: 0;
- restaurant/catering service: 0.

Physical replacement parts, consumer repair parts and service utensils are products; their names do not create labor semantics.

`SERVICE_LEAKAGE: PASS`

## 7. Facet-as-category audit
