...
class _ChatPrototypeHeader extends StatelessWidget {
  const _ChatPrototypeHeader({required this.receiverName});
...
class _ChatPrototypeDate extends StatelessWidget {
  const _ChatPrototypeDate({required this.date});
  final DateTime date;
  @override
  Widget build(BuildContext context) => Padding(
...
Widget _buildChatPrototypeBubble(_MessageBubble bubble, BuildContext context) {
