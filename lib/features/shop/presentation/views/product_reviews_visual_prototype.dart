...
class _ReviewsPrototypeHeader extends StatelessWidget {
  const _ReviewsPrototypeHeader({required this.productName});
...
class _ReviewsPrototypeSummary extends StatelessWidget {
  const _ReviewsPrototypeSummary({required this.stats});
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: _reviewsPrototypeSurface,
    child: Row(
      children: [
        Expanded(
          child: Column(
...
final _reviewsPrototypeSurface = BoxDecoration(
...
Widget _buildReviewsPrototypeAction(
...
Widget _buildReviewsPrototypeCard(_ReviewCard card, BuildContext context) {
